import 'package:eyehealthcare/admin/adminloginscreen.dart';
...
class _AdminRegisterScreenState extends State<AdminRegisterScreen> {
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: ('Admin Registration Password'.tr()),
                          hintText: ("Enter registration password".tr()),
                          labelStyle: TextStyle(
                            color: Color(0XFF8B8B8B),
                          ),
                          hintStyle: TextStyle(fontSize: (12)),
                        ...
                        obscureText: _passwordVisible,
                        validator: (value) {
                          if (value != 'eyehealthcareadmin') {
                            return ('Wrong admin registration password'.tr());
                          }
                          return null;
                        },
                      ),
  ...
  void _onRegister() async {
    if (_formKey.currentState.validate()) {
      ...
      await pr.show();
      http.post(
          "https://steadybongbibi.com/eyehealthcare/php/PHPMailerAdmin/index.php",
          body: {
            "name": _name,
            "email": _email,
            "phone": _phone,
