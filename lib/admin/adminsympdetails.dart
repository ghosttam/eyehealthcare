...
import 'package:eyehealthcare/admin/adminaccesswebsymptom.dart';
import 'package:flutter/material.dart';
import 'package:flutter_speed_dial/flutter_speed_dial.dart';
import 'package:easy_localization/easy_localization.dart';
import 'manage/editsymptom.dart';
...
class _SympDetailsState extends State<SympDetails> {
  ...
  void _editSymptom() {
    Symptom symptom = new Symptom(
        sympid: widget.symp.sympid,
        sympname: widget.symp.sympname,
        sympimage: widget.symp.sympimage,
        sympsubtitle: widget.symp.sympsubtitle,
        sympdescription: widget.symp.sympdescription,
        sympmydescription: widget.symp.sympmydescription,
        sympsymptom: widget.symp.sympsymptom,
        sympsimptom: widget.symp.sympsimptom,
        sympreference: widget.symp.sympreference,
        sympdatareg: widget.symp.sympdatareg);

    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (BuildContext context) => EditSymptom(symp: symptom)));
  }
}
