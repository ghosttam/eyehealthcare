...
class EditExerciseInfo extends StatefulWidget {
  final ExerciseInfo exeinfo;
  final Exercise exe;

  const EditExerciseInfo({
    Key key,
    this.exeinfo,
    this.exe,
  }) : super(key: key);
  @override
  _EditExerciseInfoState createState() => _EditExerciseInfoState();
}

class _EditExerciseInfoState extends State<EditExerciseInfo> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Update Exercise Info'.tr()),
      ),
      body: Container(
          child: Padding(
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 5),
                    Text("Tap image to change exercise info picture".tr(),
                    ...
                    IntrinsicHeight(
                      child: TextField(
                          ...
                          decoration: InputDecoration(
                              labelText: 'Exercise Info Name (EN & MY)',
                              hintText: 'Add malay language into a bracket',
                    ...
                    MaterialButton(
                      ...
                      elevation: 15,
                      onPressed: editExerciseInfoDialog,
                    ),
                    SizedBox(height: 10),
                  ],
                ),
  ...
  void editExerciseInfoDialog() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          title: new Text(
            "Update ".tr() + widget.exeinfo.infoname,
            style: TextStyle(
              color: Colors.black,
            ),
          ),
  ...
  void _onEditExerciseInfo() {
    ...
    if (_image == null) {
      http.post(
          "https://steadybongbibi.com/eyehealthcare/php/update_exerciseinfo.php",
          body: {
            "infoid": widget.exeinfo.infoid,
            "infoname": _infoname,
            "infostep": _infostep,
