...
import '../adminfood.dart';

void main() => runApp(AddNewFood());

class AddNewFood extends StatefulWidget {
  final Food curfood;

  const AddNewFood({Key key, this.curfood}) : super(key: key);
  @override
...
class _AddNewFoodState extends State<AddNewFood> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 5),
                    Text("Tap image to take food picture".tr(),
  ...
  void _onAddFood() {
    ...
    http.post("https://steadybongbibi.com/eyehealthcare/php/add_newfood.php",
        body: {
          "name": _name,
