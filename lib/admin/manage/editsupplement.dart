...
void main() => runApp(EditSupplement());

class EditSupplement extends StatefulWidget {
  final Supplement cursupp;

  const EditSupplement({Key key, this.cursupp}) : super(key: key);

  @override
  _EditSupplementState createState() => _EditSupplementState();
}

class _EditSupplementState extends State<EditSupplement> {
  ...
  void initState() {
    super.initState();
    _namecontroller.text = (widget.cursupp.suppname);
    _descriptioncontroller.text = (widget.cursupp.suppdescription);
    _mydescriptioncontroller.text = (widget.cursupp.suppmydescription);
    _referencecontroller.text = (widget.cursupp.suppreference);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Update Supplement'.tr()),
      ),
      body: Container(
          child: Padding(
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 5),
                    Text("Tap image to change supplement info picture".tr(),
                    ...
                    IntrinsicHeight(
                      child: TextField(
                          ...
                          decoration: InputDecoration(
                              ...
                              hintText: 'Enter malay text into a bracket'.tr(),
                    ...
                    MaterialButton(
                      ...
                      elevation: 15,
                      onPressed: editSupplementDialog,
                    ),
                    SizedBox(height: 10),
                  ],
                ),
  ...
  void editSupplementDialog() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          title: new Text(
            "Update ".tr() + widget.cursupp.suppname,
            style: TextStyle(
              color: Colors.black,
            ),
          ),
  ...
  void _onEditSupplement() {
    ...
    if (_image == null) {
      http.post(
          "https://steadybongbibi.com/eyehealthcare/php/update_supplement.php",
          body: {
            "id": widget.cursupp.suppid,
            "name": _name,
            "description": _description,
            "mydescription": _mydescription,
            "reference": _reference,
            "image": widget.cursupp.suppimage,
